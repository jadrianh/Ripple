...
public class Home extends JFrame {
    ...
    private void initializeUI() {
        ...
        noContactsLabel = new JLabel("Todavía no tienes contactos");
        ...
        // Add a ComponentListener to monitor changes in contactList
        contactList.addComponentListener(new ComponentAdapter() {
            @Override
